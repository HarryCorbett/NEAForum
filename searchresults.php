...
<div class="w3-left " id="sortingmethod"
     style="letter-spacing: 2px; padding-bottom: 0;margin-left:25%; margin-right:25%; margin-top: 5%;border-bottom: 1px solid #aaa; ">
    Sort by:
    <a href="searchresults.php?usersearch=<? echo $usersearch ?>&tagsearch=<? echo $tagsearch ?>&questionsearch=<? echo $questionsearch ?>&sort=time"
       class="w3-button">Time posted</a>
    <a href="searchresults.php?usersearch=<? echo $usersearch ?>&tagsearch=<? echo $tagsearch ?>&questionsearch=<? echo $questionsearch ?>&sort=upvotes"
       class="w3-button">Reply upvotes</a>
...
<div style="margin-left:25%; margin-right:25%; margin-top: 5%; margin-bottom: 5%;">
    ...
    foreach ($result as $idarray) {
        foreach ($idarray as $valtoadd) {
            if (!in_array($postid, $finalpostids)) {
                array_push($finalpostids, $valtoadd);
            }
        }
    }
