...
<div class="container" style="margin-left:30%; margin-right:30%;">
    ...
    <form class="form " action="includes/editpost.inc.php?postid=<? echo $postid ?>" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <textarea style="max-width: 100%; min-width: 100%;" rows="5" cols="100" class="w3-select" type="text"
                  placeholder="Enter post content" name="content" required><? echo $blob ?></textarea><br>

        <br>
        <label for="tags" class="w3-wide w3-left" style="letter-spacing: 2px;">Tags and attachments cannot be edited at
            this time</label><br>

        <br><br>
        <input type="submit" value="update" name="edit" class="w3-btn w3-light-grey w3-animate-opacity">

        <a href="postpage.php?postid=<? echo $postid ?>"
           class="w3-btn w3-light-grey w3-animate-opacity w3-right">Cancel</a>
    </form>
</div>
</body>
